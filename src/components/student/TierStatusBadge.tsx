...
export function TierStatusBadge({ tier, className, showLessonCount = true }: TierStatusBadgeProps) {
  if (!tier) {
    return (
      <Badge
        variant="outline"
      ...
      >
        ...
        Miễn phí
        {showLessonCount && <span className="ml-1">- {FREE_LESSON_COUNT} bài</span>}
      </Badge>
    )
  }
