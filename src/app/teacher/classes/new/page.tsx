...
import { ArrowLeft, Info, Upload, Link as LinkIcon } from 'lucide-react'
...
export default function NewClassPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const finalThumbnailUrl = thumbnailImageUrl || thumbnailUrlInput || null
      ...
      <div className="container max-w-2xl mx-auto p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill in the information about your class. You can edit this later.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Choose a clear, descriptive name for your class
                </p>
              </div>
                  ...
                  <TabsContent value="url" className="mt-4">
                    <div className="space-y-2">
                      <Input
                        ...
                        disabled={!!thumbnailImageUrl || loading}
                      />
        ...
        <Card className="mt-6 border-primary/20 bg-primary/5">
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>✓ Your class will be created and set to published</li>
              <li>✓ You can add courses and learning materials</li>
              <li>✓ Students can discover and join your class</li>
